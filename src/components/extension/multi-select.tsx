...
>(({ className, children, ...props }, ref) => {
  ...
  return (
    <div
      ref={ref}
      className={cn(
        "flex flex-col p-1 py-2 ring-1 ring-muted rounded-lg bg-transparent",
        {
...
>(({ className, value, children, ...props }, ref) => {
  ...
  return (
    <CommandItem
      ...
      className={cn(
        "rounded-md cursor-pointer px-2 py-1 transition-colors flex justify-between items-center",
        className,
